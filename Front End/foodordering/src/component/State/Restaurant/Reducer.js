...
const restaurantReducer =(state =initialState,action) =>{
    ...
    switch(action.type){
        ...
        case actionsTypes.GET_ALL_RESTAURANT_REQUEST:
        ...
        case actionsTypes.GET_RESTAURANT_CATEGORY_REQUEST:
            return {
               ...state,
                loading:true,
                error:null
        ...
        case actionsTypes.GET_ALL_RESTAURANT_SUCCESS:
            return {
               ...state,
                loading:false,
        ...
        case actionsTypes.GET_RESTAURANT_EVENTS_SUCCESS:
            return {
               ...state,
                loading:false,
        ...
        case actionsTypes.GET_RESTAURANT_CATEGORY_SUCCESS:
            return {
               ...state,
                loading:false,
        ...
        case actionsTypes.GET_ALL_RESTAURANT_FAILURE:
        ...
        case actionsTypes.GET_RESTAURANT_CATEGORY_FAILURE:
            return {
               ...state,
                loading:false,
